...
public class Minesweeper {
    ...
    private boolean doesUserChooseToOpenCell(final String userActionInput) {
        return userActionInput.equals("1");
    }

    private boolean doesUserChooseToPlantFlag(final String userActionInput) {
        return userActionInput.equals("2");
    }

    private int getSelectedRowIndex(final String cellInput) {
        char cellInputRow = cellInput.charAt(1);
        return convertRowFrom(cellInputRow);
    }

    private int getSelectedColIndex(final String cellInput) {
    ...
    private boolean doewUserLoseTheGame() {
        return gameStatus == -1;
    }
    ...
    private int convertRowFrom(final char cellInputRow) {
    ...
    private int convertColFrom(final char cellInputCol) {
        switch (cellInputCol) {
            case 'a':
                return 0;
            case 'b':
